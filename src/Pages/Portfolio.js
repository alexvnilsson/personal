          ...
          <div className="margin-top-2 text-align-center">
            <div>
              ...
              <p className="margin-top-2">
                ...
                kundrelationshantering och säljstöd, utvecklad under
                NetCommando, av mig själv. Utvecklad i Angular (v5), back-end:an
                utvecklades i ASP.Net Core (källkoden inte släppt).
              </p>
            </div>
          </div>
        </div>
