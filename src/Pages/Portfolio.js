      ...
      <div className="back-light">
        <div className="content text-dark">
          ...
          <div className="margin-top-2 text-align-center">
            <div>
              <img src={process.env.PUBLIC_URL + "/assets/favicon-96.png"} alt="AlexVNilsson logo" width="48px" />
              <h4 className="margin-y-0">alexvnilsson.github.io/personal</h4>

              <p className="margin-y-tiny text-align-center">
                <a className="button small no-shadow" href="https://github.com/alexvnilsson/personal" target="_blank" rel="noopener noreferrer">Källkod på GitHub</a>
              </p>

              <p className="margin-top-2">
                Min personliga webbplats (som du besöker just nu) utvecklad i React, för personlig marknadsföring och jobbansökningar.
              </p>
            </div>
          </div>
          ...
          <div className="margin-top-2 text-align-center">
            <div>
              ...
              <p className="margin-y-tiny text-align-center">
                <a className="button small no-shadow" href="https://github.com/alexvnilsson/comdocrm-app" target="_blank" rel="noopener noreferrer">Källkod på GitHub</a>
              </p>
